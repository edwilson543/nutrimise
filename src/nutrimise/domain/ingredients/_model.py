...
class NutrientUnit(django_models.TextChoices):
    ...
    MICROGRAM_RETINOL_ACTIVITY_EQUIVALENT = "MICROGRAM_RETINOL_ACTIVITY_EQUIVALENT", "µg RAE"
    MICROGRAM_DIETARY_FOLATE_EQUIVALENT = "MICROGRAM_DIETARY_FOLATE_EQUIVALENT", "µg DFE"
    KCAL = "KCAL", "kcal"
